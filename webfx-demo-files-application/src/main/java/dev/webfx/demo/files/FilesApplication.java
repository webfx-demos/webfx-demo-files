...
public class FilesApplication extends Application {
    ...
    public void start(Stage stage) {
        ...
        SegmentedButton<Boolean> sortButton = new SegmentedButton<>((Boolean) null,
        ...
        clearButton = new SegmentedButton<>((Boolean) null,
        ...
        HBox buttonBar = new HBox(10, filePicker.getView(), hGrow, listGridButton.getView(), sortButton.getView(), clearButton.getView());
